<template>
  <div class="sign-in">
    <div class="sign-top">
      ...
      <div class="top-bar after">
        <div class="my-integral">
          <div class="num">{{integrals}}</div>
          <div class="text">我的积分</div>
        </div>
        <div class="purse-img" @click.stop.prevent="signIn">
    ...
    <div class="integral-shop">
      <div class="fl" @click.stop.prevent="locateToExchange">
    ...
    <div class="more-activity">
      ...
      <div class="activity-content">
        ...
        <div class="fr">
          ...
          <div class="fr-bottom" @click.stop.prevent="locateToShare">
  ...
  methods: {
    ...
    signIn () {
      if (!this.isSign) {
        ...
        this.INCREMENT_SIGNDAYS()
        this.INCREMENT_INTEGRALS(20)
        this.CHANGE_ISSIGN()
      }
    },
    hideRule () {
