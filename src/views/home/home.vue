    ...
    >
      <div class="home-wrapper">
        ...
        <div class="goods">
          <div class="goods-top">
            <p class="top-content center-elm">
              <img src="http://m.360hwj.com/images/home_classify_1@2x.png">
            </p>
            <p class="top-icon">
        ...
        <div class="goods">
          <div class="goods-top">
            <p class="top-content center-elm">
              <img src="http://m.360hwj.com/images/home_classify_210@2x.png">
            </p>
            <p class="top-icon">
              <em class="vertical-center right-icon"></em>
            </p>
        ...
        <div class="goods">
          <div class="goods-top">
            <p class="top-content center-elm">
              <img src="http://m.360hwj.com/images/home_classify_244@2x.png">
            </p>
            <p class="top-icon">
              <em class="vertical-center right-icon"></em>
            </p>
        ...
        <div class="goods">
          <div class="goods-top">
            <p class="top-content center-elm">
              <img src="http://m.360hwj.com/images/home_classify_242@2x.png">
            </p>
            <p class="top-icon">
              <em class="vertical-center right-icon"></em>
            </p>
...
import Download from './children/download/download'
import topComponent from '../../components/topComponent/topComponent'
import SecondKill from './children/secondKill/secondKill.vue'

export default {
  name: 'home',
  components: { SecondKill, GoodList, FooterNav, Banner, Download, topComponent },
  data () {
    return {
      /* 导航名称 */
      navName: 'home',
      ...
      navItems: [
        ...
        },
        {
          ...
          text: '客服咨询',
          clickEventName: this.locateToService
        },
        {
        ...
        },
        {
          ...
          text: '超值兑换',
          clickEventName: this.locateToExchange
        }
      ],
      options: {
        click: true
